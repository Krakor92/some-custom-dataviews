...
export class VirtualizedGrid {
	...
	constructor({ manager, logger, root = null, numberOfItemPerBatch = NaN }) {
		...
		/**
		 * @todo Using this: Handle the unconsistent arrival of element in the DOM
		 */
	...
	#computeRelevantInformationForOneItemIntersection(entry, context) {
		...
		const fromTop = closestTo(rootBounds.top, rootBounds.bottom, boundingClientRect.top) === rootBounds.top
